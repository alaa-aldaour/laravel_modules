...
class LumenModuleTest extends BaseTestCase
{
    ...
    {
        $this->assertEquals('modules/recipe', $this->module->getComposerAttr('name'));
    }
...
class LumenTestingModule extends \LaravelKit\Modules\Lumen\Module
{
}
