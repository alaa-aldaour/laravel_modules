...
- [@JaberWiki](https://github.com/JaberWiki) Added Include an optional flag `subpath` for rolling back a module's specific migration file [#1626](https://github.com/laravel-kit/modules/pull/1626)
- [@sergiy-petrov](https://github.com/sergiy-petrov) Added support for testing GitHub actions against PHP versions 8.2 and 8.3. [#1624](https://github.com/laravel-kit/modules/pull/1624)
- [@hanieas](https://github.com/hanieas) Added make Observer command. [#1623](https://github.com/laravel-kit/modules/pull/1623)
- [@alissn](https://github.com/alissn) Add phpdoc to Module facade class for IDE auto-completion. [#1589](https://github.com/laravel-kit/modules/pull/1589)
- [@aryala7](https://github.com/aryala7) Add command to create broadcasting channel [#1599](https://github.com/laravel-kit/modules/pull/1599)

## Changed

- [@Rattone](https://github.com/Rattone) Updated stubs for command from `name` to `signature` [#1625](https://github.com/laravel-kit/modules/pull/1625)
- [@moeen-basra](https://github.com/moeen-basra) Remove the unused Factory import [#1596](https://github.com/laravel-kit/modules/pull/1596)
- [@moeen-basra](https://github.com/moeen-basra) Replace the \Config::get with config function [#1596](https://github.com/laravel-kit/modules/pull/1596)
- [@aryala7](https://github.com/aryala7) Changed disable module Command to accept array of modules instead of single module to disable [#1591](https://github.com/laravel-kit/modules/pull/1591)
...
- [@dev-karpenko](https://github.com/dev-karpenko) updated get attributes cache [#1526](https://github.com/laravel-kit/modules/pull/1526)

## 9.0.7 - 2022-11-17

## Added

- [@alissn](https://github.com/alissn) implement command check lang folder, and show missing files [#1496](https://github.com/laravel-kit/modules/pull/1496)
- [@kmizzi](https://github.com/kmizzi) Use AsCommand in lieu of defaultName for ModelShowCommand [#1503](https://github.com/laravel-kit/modules/pull/1503)

## 9.0.6 - 2022-10-28

## Added

- [@wikigods](https://github.com/wikigods) added vite compatibility [#1455](https://github.com/laravel-kit/modules/pull/1455)
- [@WMOH-DEV](https://github.com/WMOH-DEV) Adding migrate fresh command [#1483](https://github.com/laravel-kit/modules/pull/1483)

## 9.0.5 - 2022-08-31

## Added

- [@alissn](https://github.com/alissn) add command show model information [#1429](https://github.com/laravel-kit/modules/pull/1429) 
- [@JaberWiki](https://github.com/JaberWiki) add optional flag for seeder or request in model generator command [#1431](https://github.com/laravel-kit/modules/pull/1431)

## Changed
- [@alissn](https://github.com/alissn) updated command style to new version of artisan [#1430](https://github.com/laravel-kit/modules/pull/1430)
- [@ChauDucGiang](https://github.com/ChauDucGiang) updated Feature/cache driver [#1443](https://github.com/laravel-kit/modules/pull/1443) 

### Fixed

- [@ajayfroiden](https://github.com/alissn) fixed module:disable [#1438](https://github.com/laravel-kit/modules/pull/1438)
- [@inovar-tecnologia](https://github.com/inovar-tecnologia) fixed DisableCommand.php[#1435](https://github.com/laravel-kit/modules/pull/1435)
...
- Added option to publish stubs for modules `php artisan vendor:publish --provider="LaravelKit\Modules\ModulesServiceProvider" --tag="stubs"`

### Changed

- [@iamine](https://github.com/iamine) Added Anonymous migration class as default like in Laravel 9.0 [#1363](https://github.com/laravel-kit/modules/pull/1363)
...
- Fixed bug: `Target class [LaravelKit\Modules\Commands\] does not exist.`
...
- New File Activator feature. [PR #790](https://github.com/laravel-kit/modules/pull/790) from @ryssbowh
...
- Alternate way to define the namespace of modules in [PR #776](https://github.com/laravel-kit/modules/pull/776) by @daison12006013
...
- **BREAKING** Renamed method `enabled` to `isEnabled` in `\LaravelKit\Modules\Module`.
- **BREAKING** Renamed method `disabled` to `isDisabled` in `\LaravelKit\Modules\Module`.
- **BREAKING** Renamed method `enabled` to `isEnabled` in `\LaravelKit\Modules\FileRepository`.
- **BREAKING** Renamed method `disabled` to `isDisabled` in `\LaravelKit\Modules\FileRepository`.
- **BREAKING** Removed the `__get` magic method on the `\LaravelKit\Modules\Module` class. Use `get()` or `json()->get()` instead.
...
- Module generation namespace now works with `StudlyCase` ([Issue #14](https://github.com/laravel-kit/modules/issues/14))
