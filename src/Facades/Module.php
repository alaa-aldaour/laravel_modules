...
namespace LaravelKit\Modules\Facades;
 ...
 * @method  array scan()
 * @method  \LaravelKit\Modules\Collection toCollection()
 ...
 * @method  \LaravelKit\Modules\Module find(string $name)
 * @method  \LaravelKit\Modules\Module findOrFail(string $name)
