...
namespace LaravelKit\Modules\Generators;
...
use LaravelKit\Modules\FileRepository;
use LaravelKit\Modules\Support\Config\GenerateConfigReader;
...
class ModuleGenerator extends Generator
{
     ...
     *
     * @return \LaravelKit\Modules\Module
     */
        ...
        foreach ($this->getFiles() as $stub => $file) {
            ...
            $this->component->task("Generating file {$path}",function () use ($stub, $path) {
                if (!$this->filesystem->isDirectory($dir = dirname($path))) {
                    $this->filesystem->makeDirectory($dir, 0775, true, true);
                }
    ...
    private function testgetControllerNamespaceReplacement($str): string
    {
    ...
    protected function getReplacement($stub)
    {
        ...
        foreach ($keys as $key) {
            $method = 'get' . ucfirst(Str::studly(strtolower($key))) . 'Replacement';
    ...
    private function cleanModuleJsonFile()
    {
        ...
        $namespace = $this->getModuleNamespaceStringReplacement();
    ...
    /**
     * Get replacement for $MODULE_NAMESPACE_STRING$.
     *
     * @return string
     */
    protected function getModuleNamespaceStringReplacement()
    {
