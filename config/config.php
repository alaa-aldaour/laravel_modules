...
use LaravelKit\Modules\Activators\FileActivator;
use LaravelKit\Modules\Commands;
...
return [
    ...
    */
    ...
    'stubs' => [
        'enabled' => false,
        'path' => base_path('vendor/laravel-kit/modules/src/Commands/stubs'),
        'files' => [
        ...
        'replacements' => [
            ...
            'vite' => ['LOWER_NAME'],
            'json' => ['LOWER_NAME', 'STUDLY_NAME', 'MODULE_NAMESPACE_STRING', 'PROVIDER_NAMESPACE'],
